...
| H10 | Second factor on the **Hetzner** account | It can destroy the machine and read the console. The previous version of this set forgot this one |
...
| Annually | Re-attest H7 to H11. The check fails on an entry older than 12 months, by design |
