...
- **What is in `ops/security/alerts.md`?** Anything that looks like compromise goes to
  `06-recovery-and-incidents.md` rather than being investigated here.
...
Adopt anything. The audit produces findings; `04-improvement.md` decides what happens to them,
