...
**Criteria.** `CTR.1`-`CTR.13` all pass. Every one of them runs as the container user, not as
...
**Criteria.** `RB0.1`-`RB0.9`. Firewall active and still denying, Tailscale connected, container
